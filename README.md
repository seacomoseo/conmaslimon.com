...
- If new project (not fork):
  - Copy [conmaslimon.com project files](https://github.com/conmaslimon/conmaslimon.com)
...
- `README.md` ⏩ edit baseURL ("conmaslimon.com") + delete steps bit by bit
- Design
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/conmaslimon/domains)
  - `Set up a custom domains`
  - `conmaslimon.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.conmaslimon.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/conmaslimon/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de conmaslimon.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/conmaslimon/forms)
...
1. [Servicios conmaslimon.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
